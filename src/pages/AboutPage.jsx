...
const initialContributors = [
  {
    ...
    imageUrl:
      "https://ui-avatars.com/api/?name=Abdullahi+Mohamed&background=0D8ABC&color=fff",
    github: "https://github.com/Abdul-zaki",
  },
  {
    name: "Mohamed Nuradin",
    imageUrl:
      "https://ui-avatars.com/api/?name=Mohamed+Nuradin&background=0D8ABC&color=fff",
    github: "https://github.com/eng-ayzer",
  },
  {
    name: "Fatuma Gabow",
    imageUrl:
      "https://ui-avatars.com/api/?name=Fatuma+Gabow&background=0D8ABC&color=fff",
    ...
    <div className="flex min-h-screen flex-col lg:flex-row">
      ...
      <div className="flex flex-col flex-grow px-4 sm:px-6 lg:px-12 py-8 sm:py-12 bg-gray-100 items-center">
        ...
        <p className="text-center max-w-3xl mb-8 text-gray-700 leading-relaxed px-4">
          ConnectHub is a lightweight social networking platform designed for
          niche communities and focused peer sharing. In contrast to bloated
          platforms like Twitter or Facebook, ConnectHub brings back the
          simplicity of meaningful content sharing without distractions, ads, or
          toxic algorithms. The app allows users to create posts (text +
          optional image), follow other users, and view a personalized feed of
          content from those they follow. Its clean UI and minimal features are
          ideal for hobbyists, study groups, small online communities, and
          student cohorts — allowing people to connect around shared interests
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl px-4">
          {contributors.map((person, index) => (
            ...
            >
              <img
                src={
                  person.imageUrl && person.imageUrl.trim() !== ""
                    ? person.imageUrl
                    : defaultPic
                }
                alt={person.name}
